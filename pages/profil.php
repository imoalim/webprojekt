                ...
                if (mysqli_num_rows($res) > 0) {
                    while ($row=mysqli_fetch_array($res)){
                        ...
                        <div class="col-sm-6 my-2">
                            <input type="text" class="form-control py-2" id="fname" name="fname" placeholder="Vorname" required="required" value="<?php echo $row ['usersFName']?>">
                        </div>
                        <div class="col-sm-6 my-2">
                            <input type="text" class="form-control py-2" id="lname" name="lname" placeholder="Nachname" required="required" value="<?php echo $row ['usersLName']?>">
                        </div>
                        <div class="col-md-12 my-2">
                            <input type="text" class="form-control py-2" id="username" name="username" placeholder="Username" required="required" value="<?php echo $row ['usersUsername']?>">
                        </div>
                        <div class="col-md-12 my-2">
                            <input type="email" class="form-control py-2" id="email" name="email" placeholder="Email" required="required" value="<?php echo $row ['usersEmail']?>">
                        </div>
                        <div class="col-md-12 my-2">
